...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ] ; then
	...
	CC_SRC_PATH="../supply-chain-chaincode/fabcar/javascript/"
...
pushd ../supply-chain-network
./network.sh down
./network.sh up createChannel -c mysupplycahin -s couchdb
./network.sh deployCC -c mysupplycahin -ccn fabcar -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
